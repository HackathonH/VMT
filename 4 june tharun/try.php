...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
	...
	<a href="users_form.html" class="w3-bar-item w3-button w3-padding "><i class="fa fa-users fa-fw"></i>Enter User Details</a>
	<a href="vehicle_form.html" class="w3-bar-item w3-button w3-padding"><i class="fa fa-users fa-fw"></i>Enter Vehicle Details</a>
    <a href="mileage_form.html" class="w3-bar-item w3-button w3-padding "><i class="fa fa-users fa-fw"></i>Enter mileage Details</a>
	<a href="petrol_form.html" class="w3-bar-item w3-button w3-padding "><i class="fa fa-users fa-fw"></i>Enter petrol Details</a>
</nav>
