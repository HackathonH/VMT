                ...
                <div class="row">
                    ...
                    <div class="col-xs-10 text-right menu-1">
                        <ul>
                            ...
                            <li>
                                <a href="vehicle_form.html">Vehicle Details</a>
                            </li>
                            <li>
                                <a href="mileage_form.php">Odometer Details</a>
                            </li>
					   <li>
                                <a data-toggle="modal" data-target="#myModal2">Edit</a>
                            </li>
                        </ul>
                    </div>
                </div>
...
<div class="container" style="margin-top:65px; margin-left:330px;">
  ...
  <!-- Modal -->
  <!-- Trigger the modal with a button -->
  <button type="button" class="btn btn-info btn-lg w3-teal" style="margin-top: 15px;margin-left: 192px; " data-toggle="modal" data-target="#myModal">click for details</button>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p id="id1"><?php echo "<h4>Username is</h4> ".$var."<br>". "<h4>vehiclename is </h4>".$vname."<br>"."<h4>vechicle id is</h4>".$vid."<br>"; ?></p>
        </div>
...
document.getElementById('div1').style.display='none';
 ...
 <a href="buttonexample.php">
  ...
  <div class="w3-row-padding w3-margin-bottom" id="div1" onmouseover="var()">
      ...
      <div class="w3-container w3-brown w3-padding-48">
        ...
        <div class="w3-right">
		  ...
		  include("config.php");
			...
			$sql5 = "select count(*) as c from vehicle where vehicle_type = 'bike' and user_id= $user_id";
      ...
      <div class="w3-container w3-pink w3-padding-48">
        ...
        <div class="w3-right">
		  ...
		  include("config.php");
			...
			$sql6 = "select count(*) as c from vehicle where vehicle_type = 'car' and user_id= $user_id";
	...
	<a href="performance_vehicles.php">
    <div class="w3-quarter">
      <div class="w3-container w3-indigo w3-text-white w3-padding-48">
        ...
        <div class="w3-right">
		  ...
		  include("config.php");
			...
			$sql7 = "select count(*) as c from vehicle where user_id= $user_id";
...
<hr>
  <div class="w3-container" style="mar">
