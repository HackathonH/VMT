...
if(isset($_SESSION['uid']))
  ...
  /*    $query1 = "select user_id from vehicle where vehicle_type='bike' and vehicle_name = (select vehicle_name from  vehicle
                                                                                            where user_id = $uid);" ;
    ...
    $date_mile = array();
    $user_id_query = "select user_id from vehicle where vehicle_type='car' and vehicle_name = (select vehicle_name from  vehicle
                                                                                          where user_id = $uid);" ;
